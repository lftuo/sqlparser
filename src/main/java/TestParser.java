...
public class TestParser {
    ...
    public static void test_select(String sql) throws JSQLParserException {
        // *********select body items内容
        List<String> str_items = TestParser.test_select_items(sql);

        // **********select table
        List<String> tableList = TestParser.test_select_table(sql);

        // **********select table with join
        List<String> tablewithjoin = TestParser.test_select_join(sql);

        // // *******select where
        String str = TestParser.test_select_where(sql);

        // // ******select group by
        List<String> str_groupby = TestParser.test_select_groupby(sql);

        // //**************select order by
        List<String> str_orderby = TestParser.test_select_orderby(sql);

    }
    public static void test_insert(String sql) throws JSQLParserException {
        // ****insert table
        String string_tablename = TestParser.test_insert_table(sql);
    ...
    public static void select_fromtxt() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            TestParser.test_select(statement_list.get(i));
        }
    }
    ...
    public static void insert_fromtxt() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            TestParser.test_insert(statement_list.get(i));
        }
    }
    ...
    public static void update_fromtxt() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            TestParser.test_update(statement_list.get(i));
        }
    }
